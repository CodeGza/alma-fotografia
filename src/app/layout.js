  ...
  return (
    <html lang="es" className={`${voga.variable} ${firaSans.variable} ${cormorantGaramond.variable}`}>
      <head>
        ...
        {/* Favicon adicional para mejor compatibilidad con buscadores */}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              image: 'https://res.cloudinary.com/dav2dvukf/image/upload/v1764363487/alma-fotografia/og-image-final.png',
