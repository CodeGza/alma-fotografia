...
export default function UserManagementTable({ initialUsers }) {
  ...
  console.log('👥 UserManagementTable - Current User:', currentUser);
  console.log('🔑 UserManagementTable - Permissions:', currentUser?.permissions);
  console.log('✅ UserManagementTable - Has manage_users:', currentUser?.permissions?.manage_users);
